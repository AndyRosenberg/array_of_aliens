...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Array Of Aliens web application."
  #
  #
  ...
  #
  # settings.secret_key_base= SbZxJPFlHr5ywvKtF2mzk5e_uF8KUcHSQK-zbrhi-tU
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("array_of_aliens.log", "w"))
  #
  #
end
